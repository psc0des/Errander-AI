...
| `ERRANDER_SIGNING_SECRET` | auto-generated by configure.sh | Rotate after a suspected key compromise |
| `ERRANDER_WEB_BASE_URL` | auto-detected by configure.sh | Override in `.env` if behind NAT, load balancer, or custom domain |
