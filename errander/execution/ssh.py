...
from errander.observability.metrics import SSH_ERRORS_TOTAL
...
class SSHConnectionManager:
    ...
    async def execute(
        ...
        try:
            ...
            self._connections.pop(vm_id, None)  # stale connection — remove from pool
            SSH_ERRORS_TOTAL.labels(vm_id=vm_id, reason="timeout").inc()
            ...
            SSH_ERRORS_TOTAL.labels(vm_id=vm_id, reason="connection_error").inc()
