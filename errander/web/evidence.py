...
AUDIT_EVIDENCE: list[dict[str, Any]] = [
    ...
    {  # idx 1 — OS patching prod-web-02
        ...
        "approver":        "sre-oncall (slack reaction ✅ at 02:08:14 UTC)",
    ...
    {  # idx 2 — pre-validation prod-db-01 (pending)
        ...
        "approval_source": "slack:#errander-approvals · awaiting reaction · deadline 02:36 UTC",
        "before":          "n/a",
    ...
    {  # idx 3 — patching prod-api-01
        ...
        "approver":        "sre-oncall (slack reaction ✅ at 02:04:32 UTC)",
    ...
    {  # idx 4 — FAILED patching staging-api-01
        ...
        "approver":        "sre-oncall (slack reaction ✅ at 02:03:11 UTC)",
