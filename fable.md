...
- [ ] `deploy/` or SETUP.md — nginx reference config for Mode 2 (TLS, HSTS, rate-limit, localhost upstream, optional IP allowlist) — **deferred to Step 4 (R3) with the deploy/ work**
