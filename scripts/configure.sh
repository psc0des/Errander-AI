...
echo ""
echo "  Step 6 — Verify:"
echo "    uv sync --extra dev                    # installs pytest/ruff/mypy (skip if bootstrap.sh already ran)"
echo "    uv run playwright install chromium     # installs browser for UI tests (skip if already done)"
